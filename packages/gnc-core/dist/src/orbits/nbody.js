...
export function nbodyAcceleration(sc, bodies) {
    let ax = 0, ay = 0, az = 0;
 ...
 */
export function nbodyPropagate(sc, bodies, dt, steps) {
    let s = sc;
    for (let i = 0; i < steps; i++)
        s = nbodyRK4Step(s, bodies, dt);
    return s;
}
/**
 ...
 */
export function perturbationBreakdown(sc, bodies, primaryName = 'Earth') {
 ...
 */
export const BODIES_EARTH_MOON_SUN = [
