...
import { EKF15Navigation } from '../navigation/ekf15';
describe('EKF15Navigation', () => {
    ...
    it('GPS update reduces position residual magnitude', () => {
        ...
        const preErr = Math.hypot(pre.position[0] - baseState.position[0], pre.position[1] - baseState.position[1], pre.position[2] - baseState.position[2]);
        ekf.updateGPS({
        ...
        const postErr = Math.hypot(post.position[0] - baseState.position[0], post.position[1] - baseState.position[1], post.position[2] - baseState.position[2]);
