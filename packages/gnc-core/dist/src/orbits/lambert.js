...
function classifyConicByEnergy(energy) {
...
function estimateFeasibleTofBounds(r1, r2, A, mu) {
 ...
 */
export function lambertIzzo(r1Vec, r2Vec, tof, mu, ccw = true, maxIter = 50) {
 ...
 * at both endpoints.
 */
export function lambertDeltaV(v1Lambert, v1Orbit, v2Lambert, v2Orbit) {
